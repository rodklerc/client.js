...
// http://belgianrail.linkedconnections.org/trips/{trip_id}{?departureTime}
...
Client.prototype.query = function (q, cb) {
  ...
  if (q.departureStop && q.arrivalStop) {
    ...
    tripExtractor.on('data', function (tripId) {
      // TODO add departuretime again!
      self._config.entrypoints.push(self._tripURItemplate.expand({trip_id: tripId/*, "departureTime": q.departureTime.toString()*/}));
    })
